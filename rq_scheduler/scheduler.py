...
class Scheduler(object):
    ...
    def _create_job(self, func, args=None, kwargs=None, commit=True,
                    result_ttl=None, queue_name=None, job_id=None):
        """
        ...
        job = Job.create(func, args=args, connection=self.connection,
                         kwargs=kwargs, result_ttl=result_ttl, id=job_id)
    ...
    def schedule(self, scheduled_time, func, args=None, kwargs=None,
                interval=None, repeat=None, result_ttl=None, timeout=None, queue_name=None, job_id=None):
        """
        Schedule a job to be periodically executed, at a certain interval.
        """
        ...
        job = self._create_job(func, args=args, kwargs=kwargs, commit=False,
                               result_ttl=result_ttl, queue_name=queue_name, job_id=job_id)
